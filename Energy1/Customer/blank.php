...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/blank.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:37 GMT -->
<head>
        <meta charset="utf-8">
            ...
            <div class="sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active"><a href="blank.php" class="material-ripple"><i class="material-icons">check_box_outline_blank</i> Blank page</a></li>
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        ...
                        <div class="header-title">
                            ...
                            <ol class="breadcrumb">
                                <li><a href="index.php">This is</a></li>
