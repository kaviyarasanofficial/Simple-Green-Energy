...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/forms_editor_trumbowyg.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:35 GMT -->
<head>
        <meta charset="utf-8">
        ...
        <link href="assets/plugins/trumbowyg/css/trumbowyg.min.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        <div id="wrapper" class="wrapper animsition">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active"><a href="forms_editor_trumbowyg.php">Trumbowyg</a></li>
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        ...
                        <div class="header-title">
                            <h1>Trumbowyg Text Editor</h1>
                            <small>A lightweight WYSIWYG editor. Documentation here: <a href="https://alex-d.github.io/Trumbowyg/" target="_blank">https://alex-d.github.io/Trumbowyg/</a></small>
                            <ol class="breadcrumb">
            ...
            <p>
                Duis aute <a href="http://heeeeeeeey.com/" target="_blank">some link</a> irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
        ...
        <script src="assets/plugins/trumbowyg/js/trumbowyg.min.js" type="text/javascript"></script>
