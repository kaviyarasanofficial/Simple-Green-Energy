...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/maps_gmaps.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:36 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active"><a href="maps_gmaps.php">gMaps</a></li>
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        ...
                        <div class="header-title">
                            <h1>gmaps.js</h1>
                            <small>Google Maps API with less pain and more fun. document : <a href="https://hpneo.github.io/gmaps/" target="_blank">https://hpneo.github.io/gmaps/</a></small>
                            <ol class="breadcrumb">
                                <li><a href="index.php"><i class="pe-7s-home"></i> Home</a></li>
                                <li><a href="#">Maps</a></li>
                                <li class="active">gmaps.js</li>
                            </ol>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>GMaps.js — Overlay Map Types</h4>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <div id="gmaps5"></div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>GMaps.js — Fusion Sales layers</h4>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <div id="gmaps6"></div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>GMaps.js style extension - Styled Maps</h4>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <div id="gmaps7"></div>
        ...
        <script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyDcMXKkIZSG1Ev3nNkDE5vZpfT_KG9zBT8"></script>
...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/maps_gmaps.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:37 GMT -->
</html>