...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/maps_google.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:40:57 GMT -->
<head>
        <meta charset="utf-8">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active"><a href="maps_google.php">Google map</a></li>
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        ...
                        <div class="header-title">
                            <h1>Google Maps</h1>
                            <small>Google Maps API allows you to display maps on your web site</small>
                            <ol class="breadcrumb">
