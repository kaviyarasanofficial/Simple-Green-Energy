...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/maps_jvector.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:40:55 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active"><a href="maps_jvector.php">Jvector Maps</a></li>
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        ...
                        <div class="header-title">
                            <h1>jvectorMap</h1>
                            <small>Works in all modern browsers (including IE6-8)</small>
                            <ol class="breadcrumb">
                                <li><a href="index.php"><i class="pe-7s-home"></i> Home</a></li>
                                <li><a href="#">Maps</a></li>
                                <li class="active">Snazzy Maps</li>
                            </ol>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    <div id="asia" style="height: 350px"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    <div id="europe" style="height: 350px"></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="assets/plugins/jvectormap/jquery-jvectormap-in-mill.js" type="text/javascript"></script>
        <script src="assets/plugins/jvectormap/jquery-jvectormap-uk_countries-mill.js" type="text/javascript"></script>
        <script src="assets/plugins/jvectormap/jquery-jvectormap-us-aea.js" type="text/javascript"></script>
        <script src="assets/plugins/jvectormap/jquery-jvectormap-au-mill.js" type="text/javascript"></script>
...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/maps_jvector.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:40:57 GMT -->
</html>