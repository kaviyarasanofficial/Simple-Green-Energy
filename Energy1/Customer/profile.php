...
// If the user is logged in, retrieve the email from the session variable
...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:25 GMT -->
<head>
        <meta charset="utf-8">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-user">
                                <li class="active"><a href="profile.php"><i class="ti-user"></i>&nbsp; Profile</a></li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-content-member">
                                        <h4 class="m-t-0"><?php echo $userName; ?></h4>
