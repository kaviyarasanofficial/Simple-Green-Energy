        ...
        <div id="wrapper" class="wrapper animsition">
            ...
            <nav class="navbar navbar-fixed-top">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="customer_surveyor_index.php">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                <li class="active"><a href="charts_flot customer.php">Leads</a></li>
                                <li><a href="charts_Js customer.php">ATP</a></li>
