...
include('customer_php/userleads.php');
?>
                                        ...
                                        <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                            ...
                                            <tbody>
                                                <?php foreach ($records as $record): ?>
                                                    <tr>
                                                        <input type="hidden" value="<?= $record["surveyoremail"] ?>">
                                                        <td><?= $record["id"] ?></td>
                                                        ...
                                                        <td><?= $record["Customercity"] ?></td>
                                                        <td><?= $record["Customerpostcode"] ?></td>
                                                        <td><?= $record["Customerreference"] ?></td>
                                                        <td></td>
                                                        <td></td>
                                                        <td><?= $record["workconfirmation"] ?></td>
                                                        <td><button class="status-button" data-surveyoremail="<?= $record["surveyoremail"] ?>"><i class="hvr-buzz-out fa fa-send"></i></button></td>
                                                        <td></td>
                                                        <td></td>
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    buttons.forEach(button => {
      button.addEventListener("click", function() {
        ...
        fetch("php/surveyor_response.php", {
          method: "POST",
          body: data
        })
