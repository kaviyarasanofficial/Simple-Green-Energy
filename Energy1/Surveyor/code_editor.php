...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/code_editor.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:20 GMT -->
<head>
        <meta charset="utf-8">
        ...
        <link href="assets/plugins/codemirror/addon/fold/foldgutter.css" rel="stylesheet" type="text/css"/>
        <link href="assets/plugins/codemirror/addon/dialog/dialog.css" rel="stylesheet" type="text/css"/>
        <link href="assets/plugins/codemirror/theme/monokai.css" rel="stylesheet" type="text/css"/>
        <link href="assets/plugins/codemirror/addon/scroll/simplescrollbars.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
            ...
            <div id="page-wrapper">
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        <div class="header-icon"><i class="pe-7s-edit"></i></div>
                        <div class="header-title">
                            <h1>Code editor</h1>
                            <small>The sublime keymap defines many Sublime Text-specific bindings for CodeMirror. See the code below for an overview.</small>
                            <ol class="breadcrumb">
                            ...
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>Sublime Text bindings demo</h4>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <p><strong>CodeMirror</strong> is a versatile text editor implemented in JavaScript for the browser. It is 
                                        specialized for editing code, and comes with a number of language modes and addons that implement more 
        ...
        <script src="assets/plugins/codemirror/codemirror.js" type="text/javascript"></script>
        <script src="assets/plugins/codemirror/addon/search/searchcursor.js" type="text/javascript"></script>
        <script src="assets/plugins/codemirror/addon/search/search.js" type="text/javascript"></script>
        <script src="assets/plugins/codemirror/addon/dialog/dialog.js" type="text/javascript"></script>
        <script src="assets/plugins/codemirror/addon/edit/matchbrackets.js" type="text/javascript"></script>
        <script src="assets/plugins/codemirror/addon/edit/closebrackets.js" type="text/javascript"></script>
        <script src="assets/plugins/codemirror/addon/comment/comment.js" type="text/javascript"></script>
        <script src="assets/plugins/codemirror/addon/wrap/hardwrap.js" type="text/javascript"></script>
        <script src="assets/plugins/codemirror/addon/fold/foldcode.js" type="text/javascript"></script>
        <script src="assets/plugins/codemirror/addon/fold/brace-fold.js" type="text/javascript"></script>
        <script src="assets/plugins/codemirror/mode/javascript/javascript.js" type="text/javascript"></script>
        <script src="assets/plugins/codemirror/keymap/sublime.js" type="text/javascript"></script>
        <script src="assets/plugins/codemirror/addon/scroll/simplescrollbars.js" type="text/javascript"></script>
...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/code_editor.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:24 GMT -->
</html>