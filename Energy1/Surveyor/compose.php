...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/compose.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:27 GMT -->
<head>
        <meta charset="utf-8">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active"><a href="compose.php">Compose<span class="nav-tag red">9</span></a></li>
                            </ul>
                       <!-- </li>
                        <li>
                                            ...
                                            <div class="mailbox-sideber">
                                                <div class="profile-usermenu">
                                                    ...
                                                    <ul class="nav">
                                                        ...
                                                        <li class="active"><a href="compose.php"><i class="fa fa-envelope-o"></i>Send Mail</a></li>
...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/compose.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:28 GMT -->
</html>
