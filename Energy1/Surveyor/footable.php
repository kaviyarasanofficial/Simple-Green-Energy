...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/footable.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:01 GMT -->
<head>
        <meta charset="utf-8">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active"><a href="footable.php">FooTable</a></li>
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        ...
                        <div class="header-title">
                            <h1>Foo Sales</h1>
                            <small>A responsive table plugin built on jQuery and made for Bootstrap.</small>
                            <ol class="breadcrumb">
                            ...
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>Basic example with row toggler option </h4>
                                    </div>
                                </div>
