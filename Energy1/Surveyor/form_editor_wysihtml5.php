...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/form_editor_wysihtml5.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:35 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body>
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                               ...
                               <!-- <li><a href="form-mask.php">Create New Surveyor</a></li>
                                ...
                                <li class="active"><a href="form_editor_wysihtml5.php">Wysihtml5</a></li>
                            </ul>
                        </li>
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        ...
                        <div class="header-title">
                            <h1>Bootstrap-wysihtml5</h1>
                            <small>Simple, beautiful wysiwyg editors .Documentation here <a href="https://jhollingworth.github.io/bootstrap-wysihtml5/" target="_blank">https://jhollingworth.github.io/bootstrap-wysihtml5/</a></small>
                            <ol class="breadcrumb">
                            ...
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>Bootstrap-wysihtml5</h4>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <form method="post">
                                        <div class="form-group">
                                            <textarea id="some-textarea" class="form-control" rows="15" placeholder="Enter text ..."></textarea>
                                        </div>
                                    </form>
                                </div>
                            </div>
        ...
        <script src="assets/plugins/bootstrap-wysihtml5/wysihtml5.js" type="text/javascript"></script>
...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/form_editor_wysihtml5.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:36 GMT -->
</html>
