...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/form_file_upload.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:32 GMT -->
<head>
        <meta charset="utf-8">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level"> -->
                               ...
                               <!-- <li><a href="form-mask.php">Create New Surveyor</a></li>
                                ...
                                <!-- <li class="active"><a href="form_file_upload.php">Documents Upload here                                    <li><a href="forget_password.php">Forget password</a></li>
                                <li><a href="lockscreen.php">Lockscreen</a></li></a></li> -->
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    <p class="m-b-15"><strong>Dropzone.js</strong> is a light weight JavaScript library that turns an HTML element into a dropzone. This means 
...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/form_file_upload.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:33 GMT -->
</html>
