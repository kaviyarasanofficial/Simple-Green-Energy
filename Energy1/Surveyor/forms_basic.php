            ...
            <nav class="navbar navbar-fixed-top">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="surveyor_index.php">
                        <img class="main-logo" src="https://www.simplegreenenergy.org/wp-content/uploads/2021/06/SimpleGreenEnergy_FinalLogo.png" alt="logo">
                        <!--<span>AdminPage</span>-->
                    </a>
                </div>
                    ...
                    <ul class="nav" id="side-menu">
                       ...
                       <!-- </li>
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                <li class="active"><a href="forms_basic.php">Basic Surveyor</a></li>
