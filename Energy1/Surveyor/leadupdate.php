...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/charts_flot.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:40:52 GMT -->
<head>
        <meta charset="utf-8">
        ...
        <div id="wrapper" class="wrapper animsition">
            ...
            <nav class="navbar navbar-fixed-top">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="surveyor_index.php">
            ...
            <div class="sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a href="surveyor_index.php" class="material-ripple"><i class="material-icons">home</i> Dashboard</a></li>
                        <li class="active">
                            <a href="#" class="material-ripple"><i class="material-icons">bubble_chart</i> Survey Managements<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li><a href="charts_flot.php">Survey</a></li>
                                <li><a href="charts_Js.php">Bolier Survey</a></li>
                       ...
                       <!-- </li>
                        ...
                        <li><a href="https://thememinister.com/adminpage/documentation/surveyor_index.php" class="material-ripple" target="_blank"><i class="material-icons">bookmark</i> Documentation</a></li>-->
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
            </div>
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        ...
                        <div class="header-title">
                            ...
                            <ol class="breadcrumb">
                                <li><a href="surveyor_index.php"><i class="pe-7s-home"></i> Home</a></li>
                    ...
                    <div class="row">
            <form id="updateForm" class="row" method="post" action="leadupdates.php">
                    <!-- Left Side - 10 Fields -->
                         <div class="col-md-6">
                        
                         <div class="form-group">
                         <label>What is your current heating source?</label>
                                <div class="icon-addon addon-md input-left-icon">
                                     <select class="form-control" id="heatingSource" name="heatingSource" value="<?= $row['heatingSource']; ?>">
                                         <option value="Gas bolier" <?= ($row['heatingSource'] === 'Gas bolier') ? 'selected' : '' ?>>Gas bolier</option>
                                         <option value="Back boiler" <?= ($row['heatingSource'] === 'Back boiler') ? 'selected' : '' ?>>Back boiler</option>
                                         <option value="Electric heaters" <?= ($row['heatingSource'] === 'Electric heaters') ? 'selected' : '' ?>>Electric heaters</option>
                                         <option value="No Heating present" <?= ($row['heatingSource'] === 'Back Boiler') ? 'selected' : '' ?>>No Heating present</option>
                                     </select>
                        ...
                        <div class="form-group">
                            ...
                            <label>Is your boiler more than 18 Years old?</label>
                                <div class="icon-addon addon-md input-left-icon">
                                     <select class="form-control" id="isHeatingSourceOld" name="isHeatingSourceOld" value="<?= $row['isHeatingSourceOld']; ?>">
                                         <option value="1" <?= ($row['isHeatingSourceOld'] === '1') ? 'selected' : '' ?>>Yes</option>
                                         <option value="0" <?= ($row['isHeatingSourceOld'] === '0') ? 'selected' : '' ?>>No</option>
                        ...
                        <div class="form-group">
                            ...
                            <label>Do you own or rent the property?</label>
                                <div class="icon-addon addon-md input-left-icon">
                                     <select class="form-control" id="propertyOwnership" name="propertyOwnership" value="<?= $row['propertyOwnership'] ?>">
                                         <option value="Own" <?= ($row['propertyOwnership'] === 'Own') ? 'selected' : '' ?>>Own</option>
                                         <option value="Rent" <?= ($row['propertyOwnership'] === 'Rent') ? 'selected' : '' ?>>Rent</option>
                        ...
                        <div class="form-group">
                            ...
                            <label>Are you on any of the following benefits?</label>
                                <div class="icon-addon addon-md input-left-icon">
                                     <select class="form-control" id="benefit" name="benefit" value="<?= $row['benefit'] ?>">
                                     <option value="Job seekers allowance" <?= ($row['benefit'] === 'Job seekers allowance') ? 'selected' : '' ?>>Job seekers allowance</option>
                                         <option value="Employment and support allowance" <?= ($row['benefit'] === 'Employment and support allowance') ? 'selected' : '' ?>>Employment and support allowance</option>
                                         <option value="income support" <?= ($row['benefit'] === 'income support') ? 'selected' : '' ?>>Income support</option>
                                         <option value="Pension credit guarantee" <?= ($row['benefit'] === 'Pension credit guarantee') ? 'selected' : '' ?>>Pension credit guarantee</option>
                                         <option value="Working tax credit" <?= ($row['benefit'] === 'Working tax credit') ? 'selected' : '' ?>>Working tax credit</option>
                                         <option value="Child tax credit" <?= ($row['benefit'] === 'Child tax credit') ? 'selected' : '' ?>>Child tax credit</option>
                                         <option value="Universal credit" <?= ($row['benefit'] === 'Universal credit') ? 'selected' : '' ?>>Universal credit</option>
                                         <option value="Housing benefit" <?= ($row['benefit'] === 'Housing benefit') ? 'selected' : '' ?>>Housing benefit</option>
                                         <option value="Pension Credit savings credit" <?= ($row['benefit'] === 'Pension Credit savings credit') ? 'selected' : '' ?>>Pension Credit savings credit</option>
                                         <option value="Child Benefit" <?= ($row['benefit'] === 'Child Benefit') ? 'selected' : '' ?>>Child Benefit</option>
                                         <option value="Low Income/Health Condition" <?= ($row['benefit'] === 'Low Income/Health Condition') ? 'selected' : '' ?>>Low Income/Health Condition</option>
                                         <option value="No Benefits" <?= ($row['benefit'] === 'No Benefits') ? 'selected' : '' ?>>No Benefits</option>
                                     </select>
                                     <label class="ti-reload" title="email"></label>
                                </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="bolierAge" name="bolierAge" value="<?= $row['bedroom'] ?>"> -->
                            <label>Type of property you are applying for?</label>
                                <div class="icon-addon addon-md input-left-icon">
                                     <select class="form-control" id="property" name="property" value="<?= $row['property'] ?>">
                                     <option value="Detached House" <?= ($row['property'] === 'Detached House') ? 'selected' : '' ?>>Detached House</option>
                                         <option value="Semi-Detached House" <?= ($row['property'] === 'Semi-Detached House"') ? 'selected' : '' ?>>Semi-Detached House"</option>
                                         <option value="End-Terrance House" <?= ($row['property'] === 'End-Terrance House') ? 'selected' : '' ?>>End-Terrance House</option>
                                         <option value="Mid-Terrance House" <?= ($row['property'] === 'Mid-Terrance House') ? 'selected' : '' ?>>Mid-Terrance House</option>
                                         <option value="Bungalow" <?= ($row['property'] === 'Bungalow') ? 'selected' : '' ?>>Bungalow</option>
                                         <option value="Park Home" <?= ($row['property'] === 'Park Home') ? 'selected' : '' ?>>Park Home</option>
                                         <option value="Flat" <?= ($row['property'] === 'Flat') ? 'selected' : '' ?>>Flat</option>
                                     </select>
                                     <label class="ti-reload" title="email"></label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <label>How many bedrooms does the property have?</label>
                                <div class="icon-addon addon-md input-left-icon">
                                     <select class="form-control" id="bedroom" name="bedroom" value="<?= $row['bedroom'] ?>">
                                     <option value="1 Bedroom" <?= ($row['bedroom'] === '1 Bedroom') ? 'selected' : '' ?>>1 Bedroom</option>
                                         <option value="2 Bedrooms" <?= ($row['bedroom'] === '2 Bedrooms') ? 'selected' : '' ?>>2 Bedrooms</option>
                                         <option value="3 Bedrooms" <?= ($row['bedroom'] === '3 Bedrooms') ? 'selected' : '' ?>>3 Bedrooms</option>
                                         <option value="4 Bedrooms" <?= ($row['bedroom'] === '4 Bedrooms') ? 'selected' : '' ?>>4 Bedrooms</option>
                                         <option value="5 Bedrooms" <?= ($row['bedroom'] === '5 Bedrooms') ? 'selected' : '' ?>>5 Bedrooms</option>
                                         <option value="6+ Bedrooms" <?= ($row['bedroom'] === '6+ Bedrooms') ? 'selected' : '' ?>>6+ Bedrooms</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="propertyType" name="propertyType" value="<?= $row['wall'] ?>"> -->
                            <label>Does your property have mainly solid brick walls or cavity walls?</label>
                                <div class="icon-addon addon-md input-left-icon">
                                     <select class="form-control" id="wall" name="wall" value="<?= $row['wall'] ?>">
                                         <option value="Soild Brick Walls" <?= ($row['wall'] === 'Soild Brick Walls') ? 'selected' : '' ?>>Soild Brick Walls</option>
                                         <option value="Cavity Walls" <?= ($row['wall'] === 'Cavity Walls') ? 'selected' : '' ?>>Cavity Walls</option>
                                         <option value="Not Sure" <?= ($row['wall'] === 'Not Sure') ? 'selected' : '' ?>>Not Sure</option>
                       ...
                       <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="addressLine2" name="addressLine2" value="<?= $row['addressLine2'] ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="postcode">Reference</label>
                            <input type="text" class="form-control" id="reference" name="reference" value="<?= $row['reference'] ?>">
                        </div>
                        <div class="form-group">
