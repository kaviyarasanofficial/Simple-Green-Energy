    ...
    <body>
        ...
        <div class="lock-wrapper-page">
            <div class="text-center">
                <a href="surveyor_index.php" class="logo-lock"><i class="icon socicon-feedburner"></i> <span>AdmnPage</span> </a>
            </div>
            <form method="post" action="https://thememinister.com/adminpage/theme/adminpage_v2.0/surveyor_index.php" class="text-center m-t-20">
