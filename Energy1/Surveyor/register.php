...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/register.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:37 GMT -->
<head>
        <meta charset="utf-8">
            ...
            <div class="container-center lg">
                <div class="panel panel-bd">
                    ...
                    <div class="panel-body">
                        <form action="https://thememinister.com/adminpage/theme/adminpage_v2.0/surveyor_index.php" id="loginForm" novalidate>
                            <!--Social Buttons--> 
                            <div class="social">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="email" type="password" class="form-control" name="email" placeholder="Please enter you email adress">
                                </div>
                            </div>
                            <div>
                                <a href="#" class="btn btn-primary pull-right">Register</a>
                                <a href="login.php" class="btn btn-success pull-right m-r-5">Login</a>
                            </div>
                        </form>
                    </div>
                </div>
