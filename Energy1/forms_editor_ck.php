...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/forms_editor_ck.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:33 GMT -->
<head>
        <meta charset="utf-8">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active"><a href="forms_editor_ck.php">CK Editor</a></li>
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        ...
                        <div class="header-title">
                            <h1>CK Editor</h1>
                            <small>Enrich CKEditor with image and file uploads.</small>
                            <ol class="breadcrumb">
