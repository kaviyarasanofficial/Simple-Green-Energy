...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/forms_editor_markdown.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:34 GMT -->
<head>
        <meta charset="utf-8">
        ...
        <link href="assets/plugins/markdown/bootstrap-markdown.min.css" rel="stylesheet" type="text/css"/>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active"><a href="forms_editor_markdown.php">Markdown</a></li>
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        ...
                        <div class="header-title">
                            <h1>Markdown</h1>
                            <small>Markdown editing meet Bootstrap</small>
                            <ol class="breadcrumb">
                            ...
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>Simple Markdown editing tools that works!</h4>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <p class="m-b-20">Switch regular textarea within your form into <strong>Bootstrap-Markdown</strong> editor seamlessly by adding <code>data-provide="markdown"</code> attribute</p>
                                    <form>
    ...
    Enjoy!
                                        ...
                                        <div class="checkbox checkbox-success">
                                            ...
                                            <label for="checkbox3">Publish</label>
                                        </div>
                                        <hr/>
        ...
        <script src="assets/plugins/markdown/bootstrap-markdown.js" type="text/javascript"></script>
        <!-- START THEME LABEL SCRIPT -->
        <script src="assets/dist/js/app.min.js" type="text/javascript"></script>
        <script src="assets/dist/js/jQuery.style.switcher.min.js" type="text/javascript"></script>
    </body>

<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/forms_editor_markdown.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:35 GMT -->
</html>
