...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/maps_snazzy.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:40:57 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active"><a href="maps_snazzy.php">Snazzy Map</a></li>
                            </ul>
                        </li>
                        <li>
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        ...
                        <div class="header-title">
                            <h1>Snazzy Maps</h1>
                            <small>Snazzy Maps - Free Styles for Google Maps</small>
                            <ol class="breadcrumb">
        ...
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDcMXKkIZSG1Ev3nNkDE5vZpfT_KG9zBT8"></script>
