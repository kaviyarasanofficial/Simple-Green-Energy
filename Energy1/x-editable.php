...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/x-editable.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:01 GMT -->
<head>
        <meta charset="utf-8">
        ...
        <link href="assets/plugins/bootstrap3-editable-1.5.1/bootstrap3-editable/css/bootstrap-editable.css" rel="stylesheet" type="text/css"/>
        <link href="assets/plugins/bootstrap3-editable-1.5.1/select2-4.0.3/dist/css/select2.min.php" rel="stylesheet" type="text/css"/>
        <!-- select2 bootstrap -->
        <link href="assets/plugins/bootstrap3-editable-1.5.1/select2-bootstrap.css" rel="stylesheet" type="text/css"/>
        <!-- typeaheadjs -->
        <link href="assets/plugins/bootstrap3-editable-1.5.1/inputs-ext/typeaheadjs/lib/typeahead.js-bootstrap.css" rel="stylesheet" type="text/css"/>
        <!-- wysihtml5 -->
        <link href="assets/plugins/bootstrap3-editable-1.5.1/inputs-ext/wysihtml5/bootstrap-wysihtml5-0.0.3.css" rel="stylesheet" type="text/css"/>
        <!-- address input -->
        <link href="assets/plugins/bootstrap3-editable-1.5.1/inputs-ext/address/address.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active"><a href="x-editable.php">X-editable</a></li>
                            </ul>
                        </li>
                         <li>
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        ...
                        <div class="header-title">
                            <h1>X-editable Table</h1>
                            <small>In-place editing with Twitter Bootstrap, jQuery UI or pure jQuery</small>
                            <ol class="breadcrumb">
                            ...
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>Editable Form Example</h4>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <p class="m-b-15">This library allows you to create editable elements on your page. 
                                        It can be used with any engine (bootstrap, jquery-ui, jquery only) and includes both 
                                        popup and inline modes. Please try out demo to see how it works</p>
                                    <div class="table-responsive">
                                        <table id="user" class="table table-bordered table-striped" style="clear: both">
                                            <tbody> 
                                                ...
                                                <tr>         
                                                    <td>Surveyors List, local array, custom display</td>
                                                    <td><a href="#" id="sex" data-type="select" data-pk="1" data-value="" data-title="Surveyors List sex"></a></td>
                                                </tr>
                                                <tr>         
                                                    <td>Surveyors List, remote array, no buttons</td>
                                                    <td><a href="#" id="group" data-type="select" data-pk="1" data-value="5" data-source="/groups" data-title="Surveyors List group">Admin</a></td>
                                                </tr> 
                                                <tr>         
                                                    <td>Surveyors List, error while loading</td>
                                                    <td><a href="#" id="status" data-type="select" data-pk="1" data-value="0" data-source="/status" data-title="Surveyors List status">Active</a></td>
                                                </tr>  
                                                ...
                                                <tr>         
                                                    ...
                                                    <td><a href="#" id="dob" data-type="combodate" data-value="1984-05-15" data-format="YYYY-MM-DD" data-viewformat="DD/MM/YYYY" data-template="D / MMM / YYYY" data-pk="1"  data-title="Surveyors List Date of birth"></a></td>
                                                </tr> 
                                                <tr>         
                                                ...
                                                <tr>         
                                                    <td>Checklist</td>
                                                    <td><a href="#" id="fruits" data-type="checklist" data-value="2,3" data-title="Surveyors List fruits"></a></td>
                                                </tr>
                                                <tr>         
                                                ...
                                                <tr>         
                                                    ...
                                                    <td><a href="#" id="country" data-type="select2" data-pk="1" data-value="BS" data-title="Surveyors List country"></a></td>
                                                </tr>  
                                                <tr>         
        ...
        <!-- jquery.mockjax -->
        <script src="assets/plugins/jquery-mockjax/jquery.mockjax.min.js" type="text/javascript"></script>
        <!-- momentjs --> 
        ...
        <!-- x-editable (bootstrap 3) -->
        <script src="assets/plugins/bootstrap3-editable-1.5.1/bootstrap3-editable/js/bootstrap-editable.js" type="text/javascript"></script>
        <script src="assets/plugins/bootstrap3-editable-1.5.1/select2-4.0.3/dist/js/select2.min.php" type="text/javascript"></script>
        <!-- typeaheadjs -->
        <script src="assets/plugins/bootstrap3-editable-1.5.1/inputs-ext/typeaheadjs/lib/typeahead.js" type="text/javascript"></script>
        <script src="assets/plugins/bootstrap3-editable-1.5.1/inputs-ext/typeaheadjs/typeaheadjs.js" type="text/javascript"></script>
        <!-- wysihtml5 -->
        <script src="assets/plugins/bootstrap3-editable-1.5.1/inputs-ext/wysihtml5/wysihtml5-0.3.0.min.js" type="text/javascript"></script>
        <script src="assets/plugins/bootstrap3-editable-1.5.1/inputs-ext/wysihtml5/bootstrap-wysihtml5-0.0.3.min.js" type="text/javascript"></script>
        <script src="assets/plugins/bootstrap3-editable-1.5.1/inputs-ext/wysihtml5/wysihtml5-0.0.3.js" type="text/javascript"></script>
        <!-- address input -->
        <script src="assets/plugins/bootstrap3-editable-1.5.1/inputs-ext/address/address.js" type="text/javascript"></script>
        <script src="assets/plugins/bootstrap3-editable-1.5.1/demo-mock.js" type="text/javascript"></script>
        <script src="assets/plugins/bootstrap3-editable-1.5.1/demo.js" type="text/javascript"></script>
        <!-- START THEME LABEL SCRIPT -->
        <script src="assets/dist/js/app.min.js" type="text/javascript"></script>
        <script src="assets/dist/js/jQuery.style.switcher.min.js" type="text/javascript"></script>
    </body>

<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/x-editable.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:10 GMT -->
</html>
