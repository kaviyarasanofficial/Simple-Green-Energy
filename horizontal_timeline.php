...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/horizontal_timeline.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:15 GMT -->
<head>
        <meta charset="utf-8">
        ...
        <link href="assets/plugins/horizontal-timeline/horizontal-timeline.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active"><a href="horizontal_timeline.php">Horizontal timeline</a></li>
            ...
            <div id="page-wrapper">
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        <div class="header-icon"><i class="pe-7s-timer"></i></div>
                        <div class="header-title">
                            <h1>Horizontal Timeline</h1>
                            <small>An easy to customize, horizontal timeline powered by CSS and jQuery.</small>
                            <ol class="breadcrumb">
                                ...
                                <div class="events-content">
                                    <ol>
                                        <li class="selected" data-date="16/01/2017">
                                            ...
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illum praesentium officia, fugit recusandae ipsa,
                                                quia velit nulla adipisci? Consequuntur aspernatur at, eaque hic repellendus sit dicta consequatur quae, 
        ...
        <script src="assets/plugins/horizontal-timeline/modernizr.js" type="text/javascript"></script>
        <script src="assets/plugins/horizontal-timeline/main.js" type="text/javascript"></script>
        <!-- START THEME LABEL SCRIPT -->
        <script src="assets/dist/js/app.min.js" type="text/javascript"></script>
        <script src="assets/dist/js/jQuery.style.switcher.min.js" type="text/javascript"></script>
    </body>

<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/horizontal_timeline.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:16 GMT -->
</html>