...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/mailDetails.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:41:27 GMT -->
<head>
        <meta charset="utf-8">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active"><a href="mailDetails.php">Mailbox Details<span class="nav-tag yellow">2</span></a></li>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-9 p-0 inbox-mail">
                                            <div class="inbox-avatar p-20 border-btm">
                                                ...
                                                <div class="inbox-avatar-text">
                                                    <div class="avatar-name"><strong>From: </strong>
                                                        Tanjil Ahmed - <em>tanjil_ahmed@example.com</em>
                                                    </div>
                                            ...
                                            <div class="inbox-mail-details p-20">
                                                ...
                                                <div class="m-t-20 border-all p-20">
                                                    <p class="p-b-20">click here to <a href="#">Reply</a> or <a href="compose.php">Forward</a></p>
                                                </div> 
                                            </div>
                                        </div>
                                    </div>
