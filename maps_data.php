...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/maps_data.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:40:54 GMT -->
<head>
        <meta charset="utf-8">
...
<span class="fa arrow"></span></a>
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active"><a href="maps_data.php">Data Maps</a></li>
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        ...
                        <div class="header-title">
                            <h1>Data Maps</h1>
                            <small>Customizable SVG map visualizations for the web in a single Javascript file using D3.js</small>
                            <ol class="breadcrumb">
                                <li><a href="index.php"><i class="pe-7s-home"></i> Home</a></li>
                                <li><a href="#">Maps</a></li>
                                <li class="active">Data Maps</li>
                            </ol>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <!-- Choropleth with auto-calculated color data map -->
                        <div class="col-sm-6">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>Choropleth with auto-calculated color</h4>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <div id="map3"></div>
                        ...
                        <!-- Projections & Graticules data map -->
                        <div class="col-sm-6">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="panel-title">
...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/maps_data.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:40:55 GMT -->
</html>