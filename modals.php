...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/modals.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:40:49 GMT -->
<head>
        <meta charset="utf-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="column">
                                                ...
                                                <button class="btn btn-success md-trigger m-b-5 m-r-2" data-modal="modal-1">Fade in &amp; Scale</button>
                                                <button class="btn btn-success md-trigger m-b-5 m-r-2" data-modal="modal-2">Slide in (right)</button>
                                                <button class="btn btn-success md-trigger m-b-5 m-r-2" data-modal="modal-3">Slide in (bottom)</button>
                                                <button class="btn btn-success md-trigger m-b-5 m-r-2" data-modal="modal-4">Newspaper</button>
                                                <button class="btn btn-success md-trigger m-b-5 m-r-2" data-modal="modal-5">Fall</button>
                                                <button class="btn btn-success md-trigger m-b-5 m-r-2" data-modal="modal-6">Side Fall</button>
                                                <button class="btn btn-success md-trigger m-b-5 m-r-2" data-modal="modal-7">Sticky Up</button>
                                                <button class="btn btn-success md-trigger m-b-5 m-r-2" data-modal="modal-8">3D Flip (horizontal)</button>
                                                <button class="btn btn-success md-trigger m-b-5 m-r-2" data-modal="modal-9">3D Flip (vertical)</button>
                                                <button class="btn btn-success md-trigger m-b-5 m-r-2" data-modal="modal-10">3D Sign</button>
                                                <button class="btn btn-success md-trigger m-b-5 m-r-2" data-modal="modal-11">Super Scaled</button>
                                                <button class="btn btn-success md-trigger m-b-5 m-r-2" data-modal="modal-12">Just Me</button>
                                                <button class="btn btn-success md-trigger m-b-5 m-r-2" data-modal="modal-13">3D Slit</button>
                                                <button class="btn btn-success md-trigger m-b-5 m-r-2" data-modal="modal-14">3D Rotate Bottom</button>
                                                <button class="btn btn-success md-trigger m-b-5 m-r-2" data-modal="modal-15">3D Rotate In Left</button>
                                                <button class="btn btn-success md-trigger m-b-5 m-r-2" data-modal="modal-16">Blur</button>
                                                <!-- special modal that will add a perspective class to the html element -->
                                                <button class="btn btn-success md-trigger md-setperspective m-b-5 m-r-2" data-modal="modal-17">Let me in</button>
                                                <button class="btn btn-success md-trigger md-setperspective m-b-5 m-r-2" data-modal="modal-18">Make way!</button>
                                                <button class="btn btn-success md-trigger md-setperspective m-b-5 m-r-2" data-modal="modal-19">Slip from top</button>
                                                <!-- the overlay element -->
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    <h4 class="header-title m-t-0"><b>Modal windows</b></h4>
                                    <p>Modals are streamlined, but flexible, dialog prompts with the minimum required functionality and smart defaults.</p>
                                    <p>Modal contains title, content and footer</p>
                                    <div class="">
                                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal">Lunch demo modal</button>
                                    </div>
                                    <div class="m-t-20">
                                        <pre>&lt;button type="button" class="btn btn-success"
...
&lt;/button&gt; </pre>
                                    ...
                                    <div class="m-b-15">
                                        <button type="button" class="btn btn-purple" data-toggle="modal" data-target="#modal-lg">Large Modal</button>
                                        <button type="button" class="btn btn-purple" data-toggle="modal" data-target="#modal-sm">Small Modal</button>
                                    </div>
                                    <p class="m-b-15">You can add extra class to color your modal window avalible class (<code>modal-success</code>, <code>modal-primary</code>, <code>mmodal-warning</code>,
                                        <code>hmodal-danger</code>)</p>
                                    <div class="m-b-15">
                                        <button type="button" class="btn btn-success m-r-2 m-b-5" data-toggle="modal" data-target="#modal-success">Success</button>
                                        <button type="button" class="btn btn-primary m-r-2 m-b-5" data-toggle="modal" data-target="#modal-primary">Primary</button>
                                        <button type="button" class="btn btn-warning m-r-2 m-b-5" data-toggle="modal" data-target="#modal-warning">Warning</button>
                                        <button type="button" class="btn btn-danger m-r-2 m-b-5" data-toggle="modal" data-target="#modal-danger">Danger</button>
                                    </div>
                                    <div class="m-t-20">
                                        <pre>
...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/modals.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:40:50 GMT -->
</html>