...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/tabs.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:40:45 GMT -->
<head>
        <meta charset="utf-8">
...
<span class="fa arrow"></span></a>
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active"><a href="tabs.php">Tab</a></li>
            ...
            <div id="page-wrapper">
                ...
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 m-b-20">
                            <div class="col-xs-2 col-sm-1 p-0"> <!-- required for floating -->
                                <!-- Nav tabs -->
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab10">
                                        <div class="panel-body">
                                            ...
                                            <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
                                                The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content
                                                here, content here', making it look like readable English. Many desktop publishing packages and web</p>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="tab13">
                                        <div class="panel-body">
                                            <p><strong>fgt Ipsum is simply dummy text of the printing and. </strong></p>
                                            <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from
                                                45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, </p>
                                            <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
                                                The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content
                                                here, content here', making it look like readable English.</p>
                                        </div>
