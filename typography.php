...
<!-- Mirrored from thememinister.com/adminpage/theme/adminpage_v2.0/typography.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Oct 2023 10:40:49 GMT -->
<head>
        <meta charset="utf-8">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="panel panel-bd lobidisable">
                                ...
                                <div class="panel-body">
                                    <!--<p class="m-b-15">All HTML headings, <code>&lt;h1&gt;</code> through <code>&lt;h6&gt;</code>, are available. <code>.h1</code> through <code>.h6</code> classes are also available, for when you want to match the font styling of a heading but still want your text to be displayed inline.</p>-->
                                    <div class="headding_ex">
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <h1>h1. Heading 1</h1></td>
                                                    <td class="type-info">Semibold 36px</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <h2>h2. Heading 2</h2></td>
                                                    <td class="type-info">Semibold 30px</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <h3>h3. Heading 3</h3></td>
                                                    <td class="type-info">Semibold 24px</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <h4>h4. Heading 4</h4></td>
                                                    <td class="type-info">Semibold 18px</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <h5>h5. Heading 5</h5></td>
                                                    <td class="type-info">Semibold 14px</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <h6>h6. Heading 6</h6></td>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>Inline text elements, Contextual Text Colors</h4>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <h4 class="m-t-0">Contextual Text Colors</h4>
                                            ...
                                            <p class="text-inverse">This paragraph is styled with class "text-inverse".</p>
                                            <p class="text-purple">This paragraph is styled with class "text-purple".</p>
                                            <p class="text-pink">This paragraph is styled with class "text-pink".</p>
                                            <p class="text-black">This paragraph is styled with class "text-black".</p>
                                            <p class="text-violet">This paragraph is styled with class "text-violet".</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-bd lobidisable">
                                ...
                                <div class="panel-body">
                                    <ol>
                                        ...
                                        <li>Aenean sit amet erat nunc</li>
                                        <li>Lorem ipsum dolor sit amet,</li>
                                        <li>Quisque varius enim at risus ultrices,.</li>
                                        <li>Maecenas placerat mauris id.</li>
                                        <li>In pellentesque lacus sit .</li>
                                        <li>Sed dapibus nisl eget tempor.</li>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidisable">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>Address, Blockquotes, Alignment</h4>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-4">
                                            <h4 class="m-t-0">Address</h4>
